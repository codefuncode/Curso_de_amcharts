...
function createChart(divId) {
  ...
  var data = [{
    ...
    // 
    {
      ...
      date: new Date(2012, 1, 11).getTime(),
      value: 19
    }, {
      date: new Date(2012, 1, 12).getTime(),
      value: 21
    }, {
      date: new Date(2012, 1, 13).getTime(),
      value: 22
    }, {
      date: new Date(2012, 1, 14).getTime(),
      value: 20
    }, {
      date: new Date(2012, 1, 15).getTime(),
      value: 18
    }, {
      date: new Date(2012, 1, 16).getTime(),
      value: 14
    }, {
      date: new Date(2012, 1, 17).getTime(),
      value: 16
    }, {
      date: new Date(2012, 1, 18).getTime(),
      value: 18
    }, {
      date: new Date(2012, 1, 19).getTime(),
      value: 17
    }, {
      date: new Date(2012, 1, 20).getTime(),
      value: 15
    }, {
      date: new Date(2012, 1, 21).getTime(),
      value: 12
    }, {
      date: new Date(2012, 1, 22).getTime(),
      value: 10
    }, {
      date: new Date(2012, 1, 23).getTime(),
      value: 8
    }
  ];
